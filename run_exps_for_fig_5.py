...
def main(argv=None):
    ...
    a = method_comparison(results, tcgatissue, m, gene=opt.gene,
                          ...
                          trials=trials, search_train_size=[50], test_size=1000, g=g, graph_name=opt.graph)


def method_comparison(results, dataset, models, gene, search_num_genes, trials, search_train_size, test_size, g, graph_name):
        ...
        for ex in search_num_genes:
            ...
            for model in models:
                for seed in range(trials):
                    ...
                    result = model['method'].loop(dataset=dataset, seed=seed, train_size=train_size, test_size=test_size, adj=neighborhood, graph_name=graph_name)
