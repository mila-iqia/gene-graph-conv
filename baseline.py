...
static_settings = {
                   ...
                   "model_vars":{
                        ...
                        'mlp': [('lr', .001), ('num_channel', 32), ('weight_decay', 0.0), ('l1-loss-lambda', 0.0), ('lambdas', 0.0), ('num_layer', 0)],
...
def build_parser():
    ...
    parser.add_argument('--baseline-dataset', help="The type of baseline tests to launch", choices=['random', 'tcga-tissue', 'tcga-brca', 'tcga-label', 'tcga-gbm', 'percolate', 'nslr-syn'], required=True)
    parser.add_argument('--baseline-model', help="The type of baseline tests to launch", choices=['cgn', 'mlp', 'lcg', 'sgc', 'slr', 'cnn'], required=True)
    return parser
